...
(
    IdSubasta NUMBER GENERATED ALWAYS AS IDENTITY ( INCREMENT BY 1 START WITH 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ) NOT NULL,
    IdVendedor NUMBER,
    IdComprador NUMBER,
    ...
    CONSTRAINT Subasta_IdSubCategoria_fkey FOREIGN KEY (IdSubCategoria)
        REFERENCES public.SubCategoria (IdSubCategoria),
